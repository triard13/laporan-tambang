...
<head>
    ...
    <title>{{ config('app.name', 'Laporan Tambang') }} - Daftar</title>
    ...
    <div class="bg-white w-full max-w-[1000px] rounded-[1.5rem] shadow-2xl flex overflow-hidden min-h-[600px]">
        ...
        <div class="w-full md:w-1/2 p-8 md:p-10 lg:p-12 flex flex-col justify-between">
            ...
            <div class="w-full mx-auto flex-grow flex flex-col justify-center">
                <h2 class="text-[1.75rem] font-bold text-gray-900 mb-2">Buat Akun Baru</h2>
                <p class="text-sm text-gray-400 mb-8 font-medium">Silakan lengkapi formulir di bawah ini untuk mendaftar ke Dasbor Laporan Tambang</p>
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input id="name" type="text" name="name" value="{{ old('name') }}" required autofocus autocomplete="name" placeholder="mis. John Doe"
                    ...
                    <div>
                        ...
                        <input id="email" type="email" name="email" value="{{ old('email') }}" required autocomplete="username" placeholder="mis. admin@mail.com"
                               class="block w-full border border-gray-200 rounded-lg shadow-sm py-2.5 px-3 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 placeholder-gray-300 transition-colors" />
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input id="password" type="password" name="password" required autocomplete="new-password" placeholder="Kata sandi baru"
                                   class="block w-full border border-gray-200 rounded-lg shadow-sm py-2.5 px-3 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 placeholder-gray-300 transition-colors" />
                        ...
                        <!-- Confirm Password -->
                        <div>
                            <label for="password_confirmation" class="block text-xs font-bold text-gray-700 mb-1.5">Konfirmasi Sandi <span class="text-red-500">*</span></label>
                            <input id="password_confirmation" type="password" name="password_confirmation" required autocomplete="new-password" placeholder="Ulangi sandi"
                                   class="block w-full border border-gray-200 rounded-lg shadow-sm py-2.5 px-3 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 placeholder-gray-300 transition-colors" />
                    ...
                    <!-- Login Link -->
                    <div class="mt-4 text-center text-xs font-medium">
                        <span class="text-gray-500">Sudah punya akun?</span>
                        <a href="{{ route('login') }}" class="font-bold text-emerald-500 hover:text-emerald-600 transition-colors ml-1">Masuk</a>
                    </div>
                </form>
            </div>
